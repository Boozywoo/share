...
        'collect' => '<span class = "badge badge-danger" data-toggle = "tooltip" title = "Pick up"> <i class = "fa fa-taxi"> </ i> </ span>
        'repair' => '<span class = "badge badge-danger" data-toggle = "tooltip" title = "Repair"> <i class = "fa fa-wrench"> </ i> </ span>
...
        'completed' => '<span class = "badge badge-success" data-toggle = "tooltip" title = "Completed"> <i class = "fa fa-hourglass-end"> </ i> </ span> ',
    ],
    'reputations' => [
...
    ],
    'shift' => [
        1 => '<span class = "text-warning" data-toggle = "tooltip" title = "Swap"> <i class = "fa fa-exchange"> </ i> </ span>
        0 => '',
    ],
    'tours' => [
...
            '<span class = "label label-danger"> Pick up Complete </ span>',
