<div class="ibox-content">
    <h2>{{ trans('admin.'. $entity . '.customer_companies.list') }}</h2>
    <div class="hr-line-dashed"></div>

    @if($customerCompanies->count())
...
{{--                            <td>{{ $customerCompany->slug }}</td>--}}
                            <td class="td-actions">
                                <a href="{{route ('admin.'. $entity . '.customer_companies.edit', $customerCompany)}}"
