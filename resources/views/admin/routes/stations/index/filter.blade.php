{!! Form::open(['class' => 'form-inline js_table-search', 'method' => 'get']) !!}
    ...
    <div class="form-group">
        {!! Form::select('status', trans('admin.routes.stations.statuses'), request('status'), ['placeholder' => trans('admin.buses.sel_status'), 'class' => "form-control"]) !!}
    </div>
    {{--<button type="submit" class="btn btn-warning"><span class="fa fa-filter"></span> {{trans('admin.filter.clear')}}</button>--}}
