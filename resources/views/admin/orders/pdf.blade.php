...
<div>
    ...
    <table class="table table-condensed table-bordered">
        <tbody>
        <tr>
            <td colspan="8" width="168">&nbsp;</td>
            <td colspan="30" width="430">
                <p>
