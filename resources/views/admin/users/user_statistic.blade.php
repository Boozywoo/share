...
@section('actions')
    ...
    <a href="{{ route('admin.'. $entity . '.permissions.index') }}" class="btn btn-sm btn-warning pjax-link"><span class="fa fa-cog"></span> {{ trans('admin.'. $entity . '.permissions.title') }}</a>
    <a href="{{ route('admin.'. $entity . '.statistic') }}" class="btn btn-sm btn-warning pjax-link"><span class="fa fa-level-up"></span> {{ trans('admin.'. $entity . '.statistic') }}</a>
@endsection
