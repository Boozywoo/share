{!! Form::open(['class' => 'form-inline js_table-search', 'method' => 'get']) !!}
    <div class="form-group">
        {!! Form::text('first_name', request('first_name'), 
            [
                'placeholder' => trans('admin.clients.enter_name'),
                'class' => "form-control"
            ]
        ) !!}
    </div>
    <div class="form-group">
        {!! Form::select('status', trans('admin.users.statuses'), request('status'), 
            [
    ...
    {{--<div class="form-group">--}}
        {{--{!! Form::select('roles', $roles, request('roles'), ['placeholder' => trans('admin.users.select_role'),'class' => "form-control"]) !!}--}}
    {{--</div>--}}
