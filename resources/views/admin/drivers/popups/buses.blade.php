{!! Form::model($driver, ['route' => ['admin.'.$entity.'.set-user-buses', $driver], 'class' => 'ibox-content form-horizontal js_form-ajax js_form-ajax-popup js_form-ajax-table js_form-current-page']) !!}
