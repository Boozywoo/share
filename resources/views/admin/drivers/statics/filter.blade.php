{!! Form::open(['class' => 'form-inline js_table-search', 'method' => 'get']) !!}
    <div class="form-group">
        {!! Form::text('name', request('name'), ['placeholder' => trans('admin.drivers.enter_name'),'class' => "form-control"]) !!}
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        {!! Form::select('reputation', trans('admin.drivers.reputations'), request('reputation'), ['placeholder' => trans('admin.clients.sel_rep'),'class' => "form-control"]) !!}
    </div>
    <div class="form-group">
